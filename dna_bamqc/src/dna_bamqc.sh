...
main() {
    ...
    docker run -v ${PWD}:/data docker.io/goalconsortium/vcfannot:0.5.33 bash /seqprg/school/process_scripts/alignment/bamqc.sh -c targetpanel.bed -n dna -r ./ -b ${pair_id}.bam -p ${pair_id} -u $USER
