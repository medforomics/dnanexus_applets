...
main() {
    ...
    docker run -v ${PWD}:/data docker.io/goalconsortium/profiling_qc:1.0.4 bash /seqprg/process_scripts/alignment/bamqc.sh -c targetpanel.bed -n dna -r ./ -b ${sampleid}.bam -p ${sampleid} -u $USER
