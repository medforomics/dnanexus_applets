...
main() {
    ...
    docker run -v ${PWD}:/data docker.io/goalconsortium/vcfannot:0.5.40 bash /seqprg/school/process_scripts/alignment/bamqc.sh -c targetpanel.bed -n dna -r ./ -b ${sampleid}.bam -p ${sampleid} -u $USER
