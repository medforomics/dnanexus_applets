...
main() {
    ...
    docker run -v ${PWD}:/data docker.io/goalconsortium/starfusion:0.5.31 bash /seqprg/school/process_scripts/alignment/starfusion.sh -p ${pair_id} -r rnaref -a ${pair_id}.trim.R1.fastq.gz -b ${pair_id}.trim.R2.fastq.gz -f
