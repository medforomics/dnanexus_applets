...
main() {
    ...
    docker run -v ${PWD}:/data docker.io/goalconsortium/alignment:0.5.33 bash /seqprg/school/process_scripts/alignment/markdups.sh -a ${mdup} -b ${pair_id}.bam -p ${pair_id} -r humanref
