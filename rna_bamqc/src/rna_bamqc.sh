...
main() {
    ...
    docker run -v ${PWD}:/data docker.io/goalconsortium/vcfannot:0.5.31 bash /seqprg/school/process_scripts/alignment/bamqc.sh -p ${pair_id} -b ${pair_id}.bam -n rna 
